using zhr_person_extn_srv as service from '../../srv/external/zhr_person_extn_srv.csn';

annotate service.PersonnelAssignmentsSet with @(
    UI.LineItem : [
        {
            $Type : 'UI.DataField',
        ...
        {
            $Type : 'UI.DataField',
            Value : PositionNavn.PositionName,
            Label : 'PositionName',
        },
        {
            $Type : 'UI.DataField',
            Value : PositionNavn.PositionNumber,
